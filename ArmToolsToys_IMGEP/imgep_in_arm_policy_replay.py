...
def get_state(state, distractors):
    if distractors:
        ...
        s = list(state[0:9]) + list(state[13:15])
    return np.array(s)
...
with open("/home/tim/Documents/stage-m2/armtolstoy/arm_run_saves/imgepriseagain/active_modular_0_bk.pickle", 'rb') as handle:
