...
class BipedalWalker(gym.Env, EzPickle):
    ...
    def set_environment(self, roughness=1., stump_height=[1,3], gap_width=[3,5], step_height=[-1,1], step_number=3):
        ...
        nb_o_dims = 24 + len(self.env_param_vector)
    ...
    def _generate_terrain(self, hardcore):
        ...
        GRASS, STUMP, STAIRS, PIT = 0, None, None, None
        cpt=1
        if self.step_height:
            STAIRS = cpt
            cpt += 1
        ...
        for i in range(TERRAIN_LENGTH):
            ...
            if state==GRASS and not oneshot:
                ...
                stump_height = self.np_random.uniform(self.stump_height[0], self.stump_height[1])
                stump_width = TERRAIN_STEP
                counter = math.floor(stump_width)
                #print(counter)
                poly = [
                    (x,                      y),
                    (x+TERRAIN_STEP, y),
    ...
    def step(self, action):
        ...
        return np.array(self.env_param_vector + state), reward, done, {}
